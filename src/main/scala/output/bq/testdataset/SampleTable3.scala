...
case class SampleTable3(int64: Long, numeric: Long, float64: Double, bool: Boolean, string: String, bytes: Array[Byte], date: LocalDate, datetime: LocalDateTime, time: LocalTime, timestamp: ZonedDateTime)
